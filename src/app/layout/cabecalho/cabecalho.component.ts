...
export class CabecalhoComponent implements OnInit {
  ...
  constructor(private router: Router, private apiUsuarioDevagram: DevagramUsuarioApiService, private servicoAutenticacao: AutenticacaoService) { }
  ...
  public async pesquisarUsuarios(): Promise<void> {
    ...
    try {
      const usuariosRetornados = await this.apiUsuarioDevagram.pesquisarUsuarios(this.termoPesquisado);
